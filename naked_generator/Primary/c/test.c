...
/* Primary_SET_ACCELERATOR_RANGE */
    ...
    Primary_SET_ACCELERATOR_RANGE primary_set_accelerator_range_s = { -78 };
...
/* Primary_PEDALS_ADC_RANGES */
    ...
    Primary_PEDALS_ADC_RANGES primary_pedals_adc_ranges_s = { 19135.0, 58114.0, 61387.0, 43429.0 };
...
/* Primary_ACCELERATOR_PEDAL_VAL */
    ...
    Primary_ACCELERATOR_PEDAL_VAL primary_accelerator_pedal_val_s = { 61.0 };
...
/* Primary_BRAKE_PEDAL_VAL */
    ...
    Primary_BRAKE_PEDAL_VAL primary_brake_pedal_val_s = { 212.0 };
...
/* Primary_PCU_STATUS */
    ...
    Primary_PCU_STATUS primary_pcu_status_s = { {39}, {180} };
...
/* Primary_TIMESTAMP */
    ...
    Primary_TIMESTAMP primary_timestamp_s = { 3849464071.0 };
...
/* Primary_TLM_STATUS */
    ...
    Primary_TLM_STATUS primary_tlm_status_s = { -107, 13, 212.0, 91.0 };
...
/* Primary_CAR_STATUS */
    ...
    Primary_CAR_STATUS primary_car_status_s = { 10, -52, -110 };
...
/* Primary_SET_TLM_STATUS */
    ...
    Primary_SET_TLM_STATUS primary_set_tlm_status_s = { -88, -56, 185.0, 157.0 };
...
/* Primary_GPS_SPEED */
    ...
    Primary_GPS_SPEED primary_gps_speed_s = { 9901.0 };
...
/* Primary_HV_VOLTAGE */
    ...
    Primary_HV_VOLTAGE primary_hv_voltage_s = { 46181.0, 60937.0, 30229.0, 38997.0 };
...
/* Primary_HV_CURRENT */
    ...
    Primary_HV_CURRENT primary_hv_current_s = { 15015.0, 130.0 };
...
/* Primary_HV_TEMP */
    ...
    Primary_HV_TEMP primary_hv_temp_s = { 3589.0, 57094.0, 56304.0 };
...
/* Primary_HV_ERRORS */
    ...
    Primary_HV_ERRORS primary_hv_errors_s = { {20, 180}, {117, 158} };
...
/* Primary_TS_STATUS */
    ...
    Primary_TS_STATUS primary_ts_status_s = { -78 };
...
/* Primary_STEER_STATUS */
    ...
    Primary_STEER_STATUS primary_steer_status_s = { -44, 42, 0.0 };
...
/* Primary_SET_CAR_STATUS */
    ...
    Primary_SET_CAR_STATUS primary_set_car_status_s = { 42 };
...
/* Primary_LV_CURRENT */
    ...
    Primary_LV_CURRENT primary_lv_current_s = { 23.0 };
...
/* Primary_LV_VOLTAGE */
    ...
    Primary_LV_VOLTAGE primary_lv_voltage_s = { 29.0, 187.0, 30.0, 55.0, 14246.0 };
...
/* Primary_LV_TEMPERATURE */
    ...
    Primary_LV_TEMPERATURE primary_lv_temperature_s = { 8.0, 0, 65221.0 };
...
/* Primary_COOLING_STATUS */
    ...
    Primary_COOLING_STATUS primary_cooling_status_s = { 245.0, 173.0, 127.0 };
...
/* Primary_HV_CELLS_VOLTAGE */
    ...
    Primary_HV_CELLS_VOLTAGE primary_hv_cells_voltage_s = { 162.0, 0, 6347.0, 64715.0, 28363.0 };
...
/* Primary_HV_CELLS_TEMP */
    ...
    Primary_HV_CELLS_TEMP primary_hv_cells_temp_s = { 21.0, 148.0, 210.0, 194.0, 165.0, 175.0, 126.0, 247.0 };
...
/* Primary_SET_CHG_POWER */
    ...
    Primary_SET_CHG_POWER primary_set_chg_power_s = { 30021.0, 59738.0 };
...
/* Primary_CHG_STATUS */
    ...
    Primary_CHG_STATUS primary_chg_status_s = { 63 };
...
/* Primary_SET_CHG_STATUS */
    ...
    Primary_SET_CHG_STATUS primary_set_chg_status_s = { 69 };
...
/* Primary_CHG_SETTINGS */
    ...
    Primary_CHG_SETTINGS primary_chg_settings_s = { 181.0 };
