...
/* Primary_TIMESTAMP */
    ...
    serialize_Primary_TIMESTAMP(buffer_primary_timestamp, sizeof(Primary_TIMESTAMP), primary_timestamp_s.timestamp);
...
/* Primary_TLM_STATUS */
    ...
    serialize_Primary_TLM_STATUS(buffer_primary_tlm_status, sizeof(Primary_TLM_STATUS), primary_tlm_status_s.tlm_status, primary_tlm_status_s.race_type, primary_tlm_status_s.driver, primary_tlm_status_s.circuit);
...
/* Primary_CAR_STATUS */
    ...
    serialize_Primary_CAR_STATUS(buffer_primary_car_status, sizeof(Primary_CAR_STATUS), primary_car_status_s.car_status, primary_car_status_s.inverter_l, primary_car_status_s.inverter_r);
...
/* Primary_SET_TLM_STATUS */
    ...
    serialize_Primary_SET_TLM_STATUS(buffer_primary_set_tlm_status, sizeof(Primary_SET_TLM_STATUS), primary_set_tlm_status_s.tlm_status, primary_set_tlm_status_s.race_type, primary_set_tlm_status_s.driver, primary_set_tlm_status_s.circuit);
...
/* Primary_HV_VOLTAGE */
    ...
    serialize_Primary_HV_VOLTAGE(buffer_primary_hv_voltage, sizeof(Primary_HV_VOLTAGE), primary_hv_voltage_s.pack_voltage, primary_hv_voltage_s.bus_voltage, primary_hv_voltage_s.max_cell_voltage, primary_hv_voltage_s.min_cell_voltage);
...
/* Primary_HV_CURRENT */
    ...
    serialize_Primary_HV_CURRENT(buffer_primary_hv_current, sizeof(Primary_HV_CURRENT), primary_hv_current_s.current, primary_hv_current_s.power);
...
/* Primary_HV_TEMP */
    ...
    serialize_Primary_HV_TEMP(buffer_primary_hv_temp, sizeof(Primary_HV_TEMP), primary_hv_temp_s.average_temp, primary_hv_temp_s.max_temp, primary_hv_temp_s.min_temp);
...
/* Primary_HV_ERRORS */
    ...
    Primary_HV_ERRORS primary_hv_errors_s = { {227}, {210, 138} };
    serialize_Primary_HV_ERRORS(buffer_primary_hv_errors, sizeof(Primary_HV_ERRORS), primary_hv_errors_s.warnings, primary_hv_errors_s.errors);
    printf("\tSerialized\n\t%hhx %hhx.%hhx\n", (char)primary_hv_errors_s.warnings[0], (char)primary_hv_errors_s.errors[0], (char)primary_hv_errors_s.errors[1]);
    
    Primary_HV_ERRORS* primary_hv_errors_d = (Primary_HV_ERRORS*)malloc(sizeof(Primary_HV_ERRORS));
    deserialize_Primary_HV_ERRORS(buffer_primary_hv_errors, sizeof(Primary_HV_ERRORS), primary_hv_errors_d);
    printf("\tDeserialized\n\t%hhx %hhx.%hhx\n", (char)primary_hv_errors_d->warnings[0], (char)primary_hv_errors_d->errors[0], (char)primary_hv_errors_d->errors[1]);
...
/* Primary_TS_STATUS */
    ...
    serialize_Primary_TS_STATUS(buffer_primary_ts_status, sizeof(Primary_TS_STATUS), primary_ts_status_s.ts_status);
...
/* Primary_SET_TS_STATUS */
    ...
    serialize_Primary_SET_TS_STATUS(buffer_primary_set_ts_status, sizeof(Primary_SET_TS_STATUS), primary_set_ts_status_s.ts_status_set);
...
/* Primary_STEER_STATUS */
    ...
    serialize_Primary_STEER_STATUS(buffer_primary_steer_status, sizeof(Primary_STEER_STATUS), primary_steer_status_s.traction_control, primary_steer_status_s.map, primary_steer_status_s.radio_on);
...
/* Primary_SET_CAR_STATUS */
    ...
    serialize_Primary_SET_CAR_STATUS(buffer_primary_set_car_status, sizeof(Primary_SET_CAR_STATUS), primary_set_car_status_s.car_status_set);
...
/* Primary_LV_CURRENT */
    ...
    serialize_Primary_LV_CURRENT(buffer_primary_lv_current, sizeof(Primary_LV_CURRENT), primary_lv_current_s.current);
...
/* Primary_LV_VOLTAGE */
    ...
    serialize_Primary_LV_VOLTAGE(buffer_primary_lv_voltage, sizeof(Primary_LV_VOLTAGE), primary_lv_voltage_s.voltage_1, primary_lv_voltage_s.voltage_2, primary_lv_voltage_s.voltage_3, primary_lv_voltage_s.voltage_4, primary_lv_voltage_s.total_voltage);
...
/* Primary_LV_TEMPERATURE */
    ...
    serialize_Primary_LV_TEMPERATURE(buffer_primary_lv_temperature, sizeof(Primary_LV_TEMPERATURE), primary_lv_temperature_s.dcdc_temperature, primary_lv_temperature_s.battery_temperature);
...
/* Primary_COOLING_STATUS */
    ...
    serialize_Primary_COOLING_STATUS(buffer_primary_cooling_status, sizeof(Primary_COOLING_STATUS), primary_cooling_status_s.hv_fan_speed, primary_cooling_status_s.lv_fan_speed, primary_cooling_status_s.pump_speed);
...
/* Primary_HV_CELLS_VOLTAGE */
    ...
    serialize_Primary_HV_CELLS_VOLTAGE(buffer_primary_hv_cells_voltage, sizeof(Primary_HV_CELLS_VOLTAGE), primary_hv_cells_voltage_s.cell_index, primary_hv_cells_voltage_s.voltage_0, primary_hv_cells_voltage_s.voltage_1, primary_hv_cells_voltage_s.voltage_2);
...
/* Primary_HV_CELLS_TEMP */
    ...
    serialize_Primary_HV_CELLS_TEMP(buffer_primary_hv_cells_temp, sizeof(Primary_HV_CELLS_TEMP), primary_hv_cells_temp_s.cell_index, primary_hv_cells_temp_s.temp_0, primary_hv_cells_temp_s.temp_1, primary_hv_cells_temp_s.temp_2, primary_hv_cells_temp_s.temp_3, primary_hv_cells_temp_s.temp_4, primary_hv_cells_temp_s.temp_5, primary_hv_cells_temp_s.temp_6);
...
/* Primary_SET_CHG_POWER */
    ...
    serialize_Primary_SET_CHG_POWER(buffer_primary_set_chg_power, sizeof(Primary_SET_CHG_POWER), primary_set_chg_power_s.current, primary_set_chg_power_s.voltage);
...
/* Primary_CHG_STATUS */
    ...
    serialize_Primary_CHG_STATUS(buffer_primary_chg_status, sizeof(Primary_CHG_STATUS), primary_chg_status_s.status);
...
/* Primary_SET_CHG_STATUS */
    ...
    serialize_Primary_SET_CHG_STATUS(buffer_primary_set_chg_status, sizeof(Primary_SET_CHG_STATUS), primary_set_chg_status_s.status);
...
/* Primary_CHG_SETTINGS */
    ...
    serialize_Primary_CHG_SETTINGS(buffer_primary_chg_settings, sizeof(Primary_CHG_SETTINGS), primary_chg_settings_s.v_cutoff);
