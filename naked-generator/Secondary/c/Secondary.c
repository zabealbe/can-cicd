...
void serialize_IMU_ANGULAR_RATE(IMU_ANGULAR_RATE* imu_angular_rate, uint8_t* buffer, size_t buf_len) {
	...
	memcpy(buffer, imu_angular_rate, sizeof(IMU_ANGULAR_RATE));
}
