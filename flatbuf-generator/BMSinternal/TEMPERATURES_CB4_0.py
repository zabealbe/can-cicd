...
class TEMPERATURES_CB4_0(object):
    __slots__ = ['_tab']
...
def CreateTEMPERATURES_CB4_0(builder, temperature0, temperature1, temperature2, temperature3, temperature4, temperature5, temperature6, temperature7):
    builder.Prep(1, 8)
